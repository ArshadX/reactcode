          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">reactcodes.pro</p>
                <div className="flex items-center">
                  <a id="facebook" href="/" aria-label="social-link" className="mr-6 text-[#CED3F6] hover:text-primary">
                  ...
                  <a id="twitter" href="/" aria-label="social-link" className="mr-6 text-[#CED3F6] hover:text-primary">
                  ...
                  <a id="youtube" href="/" aria-label="social-link" className="mr-6 text-[#CED3F6] hover:text-primary">
