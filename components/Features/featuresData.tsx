...
import whatwedo from "@/public/images/About us/What_we_do.png";
import offer from "@/public/images/About us/offer.png";
import promise from "@/public/images/About us/promise.png";
import truckDrivers from "@/public/images/About us/truckDriver.png";
const featuresData: Feature[] = [
  {
    id: 1,
    icon: <Image src={whatwedo} alt="" />,
    title: "What we do",
    paragraph: "Connecting skilled drivers with opportunities.",
    paragraph1:
      "We use technology to solve the drivers workforce crunch. Our drivers go through a stringent selection process that matches the highest Road Safety Standards and are ready to go to drive.",
    paragraph2: "",
    paragraph3: "",
  },
  {
    id: 1,
    icon: <Image src={offer} alt="" />,
    title: "What we offer",
    paragraph: "✔Bus & Coach Drivers",
    paragraph1: "✔Bus & Coach Drivers",
    paragraph2: "✔Heavy Good Tuck Drivers",
    paragraph3:
      "Experienced and skilled Drivers with great understanding of their job and its discipline who are passionate about their career.",
  },
  {
    id: 1,
    icon: <Image src={promise} alt="" />,
    title: "Our Promise",
    paragraph: "Trust & Transparency",
    paragraph1:
      "All our candidates go through stringent Skills & Knowledge test that match the highest standards of Road Safety through out the world. All our candidates also have zero crimal record and zero substance abuse building trust between the candidates and the companies.",
    paragraph2:
      "All our companies have access to candidates profiles, their Skills & Knowledge test results as well as their criminal and medical fitness certificates maintaining transparency between the candidates and companies.",
    paragraph3: "",
  },
  // {
  //   id: 1,
